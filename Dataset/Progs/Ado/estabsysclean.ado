...
//Despacho n.º 6006/2016 and Decreto-Lei n.º 4/2019: U ATLANTICA changed codes, but still represents the same, in general. To simplify, we also chose to place the Escola Superior de Saúde Atlântica with the same establishment code as the Universidade Atlântica, given that if we do not do so, we will have remnants of mobility that in fact did not occur (in practice, the workers continued at the same HEI).
